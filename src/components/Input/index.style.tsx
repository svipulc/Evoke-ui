...
export const inputWrapperStyle = cva(
  "flex rounded-md relative items-center gap-1 ring-offset-background ring-1 ring-gray-300 dark:ring-gray-50/50 text-black dark:text-white bg-transparent focus-within:ring-2 focus-within:ring-ring focus-within:ring-light-secondary dark:focus-within:ring-secondary focus-within:hover:ring-light-secondary dark:focus-within:hover:ring-secondary hover:ring-light-secondary dark:hover:ring-white autofill:bg-transparent"
);

export const iconStyle = cva("w-fit h-4 text-light-silverSteel dark:text-silverSteel", {
  variants: {
    iconPosition: {
      left: "ps-3",
      right: "pe-3",
